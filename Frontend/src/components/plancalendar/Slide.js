...
import { MapWrapper, PlaceAddress, PlaceTitle, PlanBlock, PlanMakeWrapper } from "../styled/PlanCard";
...
const Slide = ({ cardData }) => {
	...
	useEffect(() => {
		...
		setState({ ...state, year: dateSplit[0], month: dateSplit[1], day: dateSplit[2], hour: timeSplit[0], minute: timeSplit[1] });
	}, []);
